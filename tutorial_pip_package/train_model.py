...
from othoz_adding_sum.src.model_lstm import LSTMModel
import click
...
@click.option('--num_of_train_dataset', default=100, help='Num of training samples to use for training. Default is 100000')
@click.option('--num_of_test_dataset', default=100, help='Num of test samples to use for testing. Default is 10000')
...
@click.option('--epochs', default=1, help='Epochs rate. Default is 1000')
